...
public class Core {
  ...
  Function<Result<SuccessT, FailureT>, Result<NewSuccessT, FailureT>> onSuccess(
  ...
  Function<Result<SuccessT, FailureT>, Result<SuccessT, NewFailureT>> onFailure(
  ...
  Function<Result<SuccessT, FailureT>, Result<NewSuccessT, FailureT>> attempt(
      Function<SuccessT, Result<NewSuccessT, NewFailureT>> f
  ) {
    return r -> r.either(
